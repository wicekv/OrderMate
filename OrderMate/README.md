...
To update the database use this command from the Web project folder (replace `OrderMate` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../OrderMate.Infrastructure/OrderMate.Infrastructure.csproj -s OrderMate.Web.csproj
```
